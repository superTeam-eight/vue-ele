<template>
    <div class="box">
        <div class="logobox">
            <svg viewBox="0 0 142 58" id="logo" width="50%" height="50%">
    ...
    export default {
        ...
        methods: {
            async verificationCode() {
                await this.$store.dispatch('login/verification')
            },
            async login() {
        ...
        computed:{
             verificationcode() {
                if (this.$store.state.login.verificationcode.data) {
                    return this.$store.state.login.verificationcode.data.code
                }
            }
        },
        created() {
